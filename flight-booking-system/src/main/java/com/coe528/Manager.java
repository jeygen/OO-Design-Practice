...
public class Manager {
    ...
    */
    ...
    public static void main(String [] args) {
        ...
        // Booking Passengeris on Flight 737
        ...
        System.out.println("Total number of tickets issued: " + Manager.tickList.length);
        System.out.println("Current flight capacity of " + Manager.fList[0].getFlightNumber() + " is " + Manager.fList[0].getCapacity());
        System.out.println();
